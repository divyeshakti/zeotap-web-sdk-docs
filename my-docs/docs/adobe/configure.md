...
After configuration is complete, you can proceed to set up [rules and actions](/adobeLaunch/docs/Actions/actions) for tracking events, syncing user identities, and managing consent.