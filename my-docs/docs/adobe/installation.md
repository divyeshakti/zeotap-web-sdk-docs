...
Before you can [configure rules](/adobeLaunch/docs/Actions/actions) or begin [tracking events](/adobeLaunch/docs/Actions/trackEvents), you need to install the **Zeotap Collect Extension** into your **Adobe Experience Platform Launch** property.
...
- Proceed to [configure the extension](/adobeLaunch/docs/configure)
...
After installation and configuration, you can proceed to set up [rules and actions](/adobeLaunch/docs/Actions/actions) for tracking events, syncing user identities, and managing consent.
