...
For more information about other actions, see our guides on [tracking events](/adobeLaunch/docs/Actions/trackEvents) and [syncing user identities](/adobeLaunch/docs/Actions/syncUserIdentity). To learn about setting up rules and actions in general, refer to our [actions setup guide](/adobeLaunch/docs/Actions/actions).
