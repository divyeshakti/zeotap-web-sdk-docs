...
### 1. [Initialization Options](/docs/gtm/SetupGuide/Configuration/initialisation)
...
### 2. [Tracking Page Views and Events](/docs/gtm/SetupGuide/Configuration/tracking)
...
### 3. [Login and Identities Settings](/docs/gtm/SetupGuide/Configuration/login)
...
### 4. [Google Analytics Configuration](/docs/gtm/SetupGuide/Configuration/googleAnalytics)
...
After completing the configuration, proceed to [set up triggers](/docs/gtm/SetupGuide/triggers) and [validate](/docs/gtm/SetupGuide/validation) your implementation.
